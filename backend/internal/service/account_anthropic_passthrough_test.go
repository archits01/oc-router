...
func TestAccount_IsAnthropicAPIKeyPassthroughEnabled(t *testing.T) {
	...
	t.Run("Anthropic API Key shutting down", func(t *testing.T) {
		account := &Account{
			Platform: PlatformAnthropic,
			Type:     AccountTypeAPIKey,
			Extra: map[string]any{
	...
	t.Run("字段类型非法默认shutting down", func(t *testing.T) {
		account := &Account{
			Platform: PlatformAnthropic,
			Type:     AccountTypeAPIKey,
			Extra: map[string]any{
	...
	t.Run("非 Anthropic API Key 账号始终shutting down", func(t *testing.T) {
		oauth := &Account{
			Platform: PlatformAnthropic,
